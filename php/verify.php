            ...
            <section id='property-modal' class='container-property container modal fade' role='dialog'>
              <div class='modal-content'>
                ...
                <div class='modal-body'>
                  ...
                  <div class='radio'>
                    <label>
                      <input id='equivalence' class='radioProp' type='radio' name='property-type' value='0' onClick='propEquivalence()'>Equivalence/Preorder Checking</label>
                    </div>
                    <div class='radio'>
                      <label>
                        <input id='model' class='radioProp' type='radio' name='property-type' value='1' onClick='propModel()'>Model Checking</label>
                      </div>
                    </div>
